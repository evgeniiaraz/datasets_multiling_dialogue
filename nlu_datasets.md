...
<div align="center">Table 1: Datasets in English. <br/> The focus of the review is multilingual task-oriented dialogue systems. Thus, the list is not exhaustive. <br/> We invite additions of other English datasets into this table.  </div>
